 ...
 * OpenRouter is wire-compatible with OpenAI's `chat/completions` shape —
 * only the base URL, auth header value, and the `model` field (routed,
 * vendor-prefixed IDs like `openai/gpt-5.4-mini`) differ. Returns the raw
