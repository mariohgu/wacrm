...
import { PushNotificationsPanel } from '@/components/settings/push-notifications';
...
import { SalonBookingConfig } from '@/components/settings/salon-booking-config';
import {
  resolveSection,
...
function SettingsPageInner() {
  ...
  const panel: Record<SettingsSection, ReactNode> = {
    ...
    members: <MembersTab />,
    api: <ApiKeysSettings />,
    'salon-booking': <SalonBookingConfig />,
  };
